...
class Trader:
    def __init__(self):
        ...
        self.products_ml = ["JAMS", "DJEMBES"]
        self.products_stat = ["KELP", "RAINFOREST_RESIN"]
        self.products_zscore = {
            "CROISSANTS": {"short_window": 8, "long_window": 100, "z_entry": 1.8, "volume": 15}, #1.8 is best: 10 to 8
            "SQUID_INK": {"short_window": 10, "long_window": 100, "z_entry": 2.5, "volume": 15}
        }
    ...
    def run(self, state: TradingState):
        ...
        for product in self.all_products:
            ...
            # --- ML STRATEGY ---
                ...
                signal = 1 if proba > 0.85 else -1 if proba < 0.15 else 0
