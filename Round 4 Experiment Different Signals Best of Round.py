...
class OnlineDirectionModel:
    def __init__(self, feature_dim=4, learning_rate=0.008): #0.01->0.005
...
class Trader:
    def __init__(self):
        ...
        self.ml_signal_config = {
            ...
            "DJEMBES": {"high": 0.80, "low": 0.20}, #Changed .9->.85 and .1->.15
            ...
            "MAGNIFICENT_MACARONS": {"high": 0.80, "low": 0.20}
        }
        ...
        self.products_zscore = {
            ...
            "SQUID_INK": {"short_window": 10, "long_window": 100, "z_entry": 3, "volume": 15} 
        }
        ...
        self.position_limits = {
            "CROISSANTS": 250, "JAMS": 350, "DJEMBES": 60, "SQUID_INK": 50,
